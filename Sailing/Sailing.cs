...
namespace Sailing
{
	...
	public class Sailing : BaseUnityPlugin
	{
		...
		public static ConfigEntry<bool> IncreaseExploreRadiusEnabled;
		public static ConfigEntry<bool> BuildingGivesXPEnabled;
		public static ConfigEntry<bool> IncreaseShipHealthEnabled;
		...
		public void Awake()
		{
			...
			IncreaseExploreRadiusEnabled = Config.Bind("Settings", nameof(IncreaseExploreRadiusEnabled), false, "Increases the explored radius when sailing");
			BuildingGivesXPEnabled = Config.Bind("Settings", nameof(BuildingGivesXPEnabled), false, "Building ships increases sailing skill");
			IncreaseShipHealthEnabled  = Config.Bind("Settings", nameof(IncreaseShipHealthEnabled), false, "Base ships health on the crafter's Sailing skill level");
		...
		private class AddZDO
		{
			...
			{
                if (BuildingGivesXPEnabled.Value)
                {
		...
		private class IncreaseHealth
		{
			...
			{
                if (IncreaseShipHealthEnabled.Value)
                {
		...
		private class IncreaseExplorationRadius
		{
			...
			private static void Prefix(Minimap __instance, ref float radius)
			{
                ...
                if (IncreaseExploreRadiusEnabled.Value)
                {
